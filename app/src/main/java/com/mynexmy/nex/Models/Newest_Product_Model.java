...
public class Newest_Product_Model {
    ...
    public Newest_Product_Model(int product_id, double product_rating, String product_title,
                     String product_description, int product_rating_total,
                     String product_image, int product_sell_price, int product_reg_price,int added_by)
    {
