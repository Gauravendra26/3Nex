...
public class DotsAdapter extends RecyclerView.Adapter<DotsAdapter.DotsViewHolder> {
    ...
    private final List<Slide_Model_Grocery> itemList; // List to hold Slide_Model_Grocery objects
    private int selectedPosition = 0;

    public DotsAdapter(Context context, List<Slide_Model_Grocery> itemList) {
