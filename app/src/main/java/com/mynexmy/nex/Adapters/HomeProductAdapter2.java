...
public class HomeProductAdapter2 extends RecyclerView.Adapter<HomeProductAdapter2.MyViewHolder> {

    private final int limit = 20;

    private Context context;
    private List<HomeProductModel2> liveList;


    private HomeProductAdapter2.ProductPageClick productPageClick;

    //make interface like this
    public interface  ProductPageClick{

        void dataUpdate(int position);
        void productClickView(int position, int product_id, int category_id, double product_rating,
        ...
        void addToCartView(int position, int product_id, int category_id, double product_rating,
    ...
    public HomeProductAdapter2(Context context, List<HomeProductModel2> liveList) {
    ...
    @NonNull
    @Override
    public HomeProductAdapter2.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_layout6_view1, parent, false);
        return new HomeProductAdapter2.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull HomeProductAdapter2.MyViewHolder holder,
                                 @SuppressLint("RecyclerView") int position) {

        HomeProductModel2 live = liveList.get(position);
        ...
        holder.ll1.setOnClickListener(new View.OnClickListener()  {
            ...
            public void onClick(View v) {
                productPageClick.productClickView(position, live.getProduct_id(), live.getCategory_id(),
        ...
        holder.add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                productPageClick.addToCartView(position, live.getProduct_id(), live.getCategory_id(),
                        live.getProduct_rating(), live.getProduct_image(), live.getProduct_title(),
                        live.getProduct_sell_price(),live.getProduct_description(),
                        live.getProduct_rating_total(), live.getProduct_reg_price(), live.getProduct_tax_percent());
    ...
    public void set(HomeProductAdapter2.ProductPageClick onClick)
    {
