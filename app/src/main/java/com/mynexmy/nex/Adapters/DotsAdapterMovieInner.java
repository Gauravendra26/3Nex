...
public class DotsAdapterMovieInner extends RecyclerView.Adapter<DotsAdapterMovieInner.DotsViewHolder> {

    private final Context context;
    private final List<Slide_Model_MovieInner> itemList; // List to hold Slide_Model_Grocery objects
    private int selectedPosition = 0;

    public DotsAdapterMovieInner(Context context, List<Slide_Model_MovieInner> itemList) {
