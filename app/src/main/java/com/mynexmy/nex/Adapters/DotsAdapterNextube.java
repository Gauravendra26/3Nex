...
public class DotsAdapterNextube extends RecyclerView.Adapter<DotsAdapterNextube.DotsViewHolder> {

    private final Context context;
    private final List<Slide_Model_Nextube> itemList; // List to hold Slide_Model_Grocery objects
    private int selectedPosition = 0;

    public DotsAdapterNextube(Context context, List<Slide_Model_Nextube> itemList) {
