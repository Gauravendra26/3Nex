...
public class DotsAdapterClothing extends RecyclerView.Adapter<DotsAdapterClothing.DotsViewHolder> {

    private final Context context;
    private final List<Slide_Model_Clothing> itemList; // List to hold Slide_Model_Grocery objects
    private int selectedPosition = 0;

    public DotsAdapterClothing(Context context, List<Slide_Model_Clothing> itemList) {
