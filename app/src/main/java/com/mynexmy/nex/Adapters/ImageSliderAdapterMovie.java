...
public class ImageSliderAdapterMovie extends RecyclerView.Adapter<ImageSliderAdapterMovie.ImageViewHolder> {
    private Context context;
    private List<Slide_Model_Movie> slide_model_movies;

    private ImageSliderAdapterMovie.whenClick onClick;
    ...
    public ImageSliderAdapterMovie(Context context, List<Slide_Model_Movie> slide_model_movies) {
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        Slide_Model_Movie slideModel = slide_model_movies.get(position);
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int indicator = slideModel.getIndicator();
                if (indicator == 1) {
    ...
    public void set(ImageSliderAdapterMovie.whenClick onClick) {
