...
public class SliderAdapterClothing extends RecyclerView.Adapter<SliderAdapterClothing.ImageViewHolder> {
    private Context context;
    private List<Slide_Model_Clothing> slide_model_clothings;





    public SliderAdapterClothing(Context context, List<Slide_Model_Clothing> slide_model_clothings) {
        this.context = context;
        this.slide_model_clothings = slide_model_clothings;
    }
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        Slide_Model_Clothing slideModel = slide_model_clothings.get(position);
    ...
    public int getItemCount() {
        ...
        Log.d("ImageSliderAdapterScratch", "Item count: " + slide_model_clothings.size());
        return slide_model_clothings.size();
    }
