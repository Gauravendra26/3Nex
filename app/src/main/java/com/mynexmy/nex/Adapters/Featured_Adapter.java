...
public class Featured_Adapter extends RecyclerView.Adapter<Featured_Adapter.MyViewHolder> {


    private Context context;
    private List<Featured_Model> liveList;

    private Featured_Adapter.ProductPageClick productPageClick;
    ...
    public Featured_Adapter(Context context, List<Featured_Model> liveList) {
    ...
    @NonNull
    @Override
    public Featured_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_layout6_view1, parent, false);
        return new Featured_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Featured_Adapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        Featured_Model live = liveList.get(position);
    ...
    public void set(Featured_Adapter.ProductPageClick onClick)
    {
