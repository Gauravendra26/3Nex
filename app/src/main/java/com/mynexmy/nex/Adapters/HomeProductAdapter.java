...
public class HomeProductAdapter extends RecyclerView.Adapter<HomeProductAdapter.MyViewHolder> {
    ...
    private List<HomeProductModel> liveList;

    private HomeProductAdapter.ProductPageClick productPageClick;
    ...
    public HomeProductAdapter(Context context, List<HomeProductModel> liveList) {
    ...
    @NonNull
    @Override
    public HomeProductAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_layout6_view1, parent, false);
        return new HomeProductAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull HomeProductAdapter.MyViewHolder holder,
                                 @SuppressLint("RecyclerView") int position) {

        HomeProductModel live = liveList.get(position);
    ...
    public void set(HomeProductAdapter.ProductPageClick onClick)
    {
