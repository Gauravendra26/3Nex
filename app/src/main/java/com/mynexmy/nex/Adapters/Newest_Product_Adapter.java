...
public class Newest_Product_Adapter extends RecyclerView.Adapter<Newest_Product_Adapter.MyViewHolder> {


    private Context context;
    private List<Newest_Product_Model> liveList;

    private Newest_Product_Adapter.ProductPageClick productPageClick;
    ...
    public Newest_Product_Adapter(Context context, List<Newest_Product_Model> liveList) {
    ...
    @NonNull
    @Override
    public Newest_Product_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_layout6_view1, parent, false);
        return new Newest_Product_Adapter.MyViewHolder(itemView);
    }



    @Override
    public void onBindViewHolder(@NonNull Newest_Product_Adapter.MyViewHolder holder,
                                 @SuppressLint("RecyclerView") int position) {

        Newest_Product_Model live = liveList.get(position);
        ...
        holder.pd_1.setOnClickListener(new View.OnClickListener()  {
            ...
            public void onClick(View v) {
                productPageClick.productClick(position, live.getProduct_id(),live.getCategory_id(),
                        ...
                        live.getProduct_sell_price(),live.getProduct_description(),live.getProduct_rating_total(),
                        live.getProduct_reg_price());
            }
    ...
    public void set(Newest_Product_Adapter.ProductPageClick onClick)
    {
