...
public class SliderAdapterNextube extends RecyclerView.Adapter<SliderAdapterNextube.ImageViewHolder> {
    private Context context;
    private List<Slide_Model_Nextube> slide_model_nextubes;





    public SliderAdapterNextube(Context context, List<Slide_Model_Nextube> slide_model_nextubes) {
        this.context = context;
        this.slide_model_nextubes = slide_model_nextubes;
    }
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        Slide_Model_Nextube slideModel = slide_model_nextubes.get(position);
    ...
    public int getItemCount() {
        ...
        Log.d("ImageSliderAdapterScratch", "Item count: " + slide_model_nextubes.size());
        return slide_model_nextubes.size();
    }
