...
import com.mynexmy.nex.Adapters.Newest_Product_Adapter;
import com.mynexmy.nex.ApiData;
import com.mynexmy.nex.Models.Newest_Model;
import com.mynexmy.nex.Models.Newest_Product_Model;
...
public class Viewall_Product_3_Activity extends AppCompatActivity implements
        Newest_Product_Adapter.ProductPageClick {

    RequestQueue requestQueue;
    ProgressDialog progressDialog;
    List<Newest_Product_Model> newest_product_models;
    Newest_Product_Adapter newest_product_adapter;
    RecyclerView rvView;
    ImageView btn_back1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewall_product3);
        Utils.blackIconStatusBar(Viewall_Product_3_Activity.this, R.color.white);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (response.getBoolean("status") == true) {
                                newest_product_models = new ArrayList<Newest_Product_Model>();
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    newest_product_models.add(new Newest_Product_Model(product_id, product_rating,
                                            product_title, product_description, product_rating_total,
                                            product_image, product_sell_price, product_reg_price, added_by));
                                }

                                newest_product_adapter = new Newest_Product_Adapter(getApplicationContext(),
                                        newest_product_models);
                                ...
                                rvView.setAdapter(newest_product_adapter);
                                newest_product_adapter.set(Viewall_Product_3_Activity.this);
